    ...
    <Modal
      ...
      <View style={styles.modalOverlay}>
        <BlurView
          ...
          blurAmount={4} // Adjust blur intensity (0-100)
        ...
        <View style={styles.modalContainer}>
          <BlurView
            style={StyleSheet.absoluteFill}
            blurType="light" // Options: 'light', 'dark', 'xlight', 'regular', etc.
            blurAmount={5} // Adjust blur intensity (0-100)
          ...
          <TouchableOpacity
            ...
            <Image
              source={require('../../assets/Icons/close.png')} // Update the path as needed
          ...
          <GlassButton
            ...
            onPress={async () => {
              ...
              try {
                ...
                onImageSelected(image.path); // Send image to AddPhoto component
              } catch (err) {
          ...
          <GlassButton
            ...
            onPress={async () => {
              ...
              try {
                ...
                newUris.forEach(uri => onImageSelected(uri));
              } catch (err) {
...
const styles = StyleSheet.create({
  ...
  exampleImage: {
    width: width * 0.75,
    height: width * 0.75, // Square aspect ratio
    borderRadius: 12,
    marginBottom: 12,
  },
